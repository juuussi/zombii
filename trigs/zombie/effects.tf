...
/def_effect -p'combat_trance' -n'Combat Trance'
/def -Fp5 -msimple -aCgreen -t'Your movements are now more focused and your mind is calm.' combat_trance_on = /effect_on combat_trance
/def -Fp5 -msimple -aCred -t'You lose your concentration and fight with less precision.' combat_trance_off = /effect_off combat_trance
...
/def_effect -p'wolf_eyes' -n'Wolf Eyes'
/def -Fp5 -msimple -aCgreen -t'Your eyes gleam yellow and your night vision improves.' wolf_eyes_on = /effect_on wolf_eyes
/def -Fp5 -msimple -aCred -t'Your yellow wolf eyes turn back to normal.' wolf_eyes_off = /effect_off wolf_eyes
